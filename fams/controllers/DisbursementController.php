...
class DisbursementController
{
    ...
    public static function list(PDO $pdo, Auth $auth, Logger $logger): void
    {
        ...
        if ($appId) {
            ...
            $sql = "SELECT d.*, a.id AS app_id, a.input_language AS app_lang, ap.full_name AS applicant_name, v.name AS village_name, v.district as village_district, u.full_name AS auth_name, ua.full_name as assigned_name
                    FROM disbursements d 
